...
| **Status** | 254 unit tests, 102 consistency checks, 2 evidence bundles replaying clean |
...
python -m pytest tests             # 254 passed
...
├── tests/                         254 tests guarding the load-bearing parts
│
